...
declare function __VLS_template(): {
    ...
    refs: {
        _popover: ({
            ...
            "onClick-outside"?: ((value: import('../..').BvTriggerableEvent) => any) | undefined;
            "onClose-on-hide"?: ((value: import('../..').BvTriggerableEvent) => any) | undefined;
        }>, "toggle" | "hide" | ("body" | "id" | "target" | "variant" | "bodyClass" | "placement" | "title" | "teleportDisabled" | "teleportTo" | "noFade" | "show" | "lazy" | "boundary" | "boundaryPadding" | "floatingMiddleware" | "noFlip" | "noShift" | "noSize" | "offset" | "strategy" | "click" | "closeOnHide" | "delay" | "hideMargin" | "inline" | "manual" | "noAutoClose" | "noHide" | "noninteractive" | "realtime" | "reference" | "titleClass" | "tooltip" | "initialAnimation" | "unmountLazy" | "visible")> & import('vue').ShallowUnwrapRef<{
            hide: (trigger?: string, noTriggerEmit?: boolean) => Promise<string>;
            show: (resolveOnHide?: boolean) => Promise<boolean | string>;
            toggle: (resolveOnHide?: boolean) => Promise<boolean | string>;
